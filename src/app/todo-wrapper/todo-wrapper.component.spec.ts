...
describe('TodoWrapperComponent', () => {
  ...
  it('receiveTodoValue should add todo value to todolistArr', () => {
    const todoValue = 'Test Todo';
    component.receiveTodovalue(todoValue);

    expect(component.todolistArr).toContain(todoValue);
  });
});
